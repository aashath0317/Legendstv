                ...
                <div className="flex flex-col xl:flex-row gap-16 items-start">
                    ...
                    <div className="w-full xl:w-5/12 flex flex-col items-start text-center xl:text-left pt-4">
                        ...
                        <div className="space-y-6 text-gray-400 text-lg leading-relaxed font-medium">
                            <p>
                                LegendsTV connects brands with audiences through authentic, legend-led storytelling.
                            </p>
                            <p>
                                Our partners harness the unmatched influence and credibility of professional Legends to drive deeper engagement and higher conversion.
                            </p>
                            <p>
                                Through custom integrations and talent-powered campaigns, we amplify brand impact—while keeping fans at the center.
                            </p>
                        </div>
                    </div>
                </div>
