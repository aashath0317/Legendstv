            ...
            <div className="w-full max-w-[1600px] mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center relative z-10">
                <div className="space-y-8 pt-4 text-center lg:text-left">
                    ...
                    <p className="text-gray-300 text-lg leading-relaxed max-w-2xl mx-auto lg:mx-0 font-medium">
                        As the first-ever legend and fan-owned media platform, we’re building the future of sports media. Supported by 50+ legend investors, diverse content, and advanced distribution, our mission is well underway. For a limited time, we’re opening this one-of-a-kind ownership opportunity to investors like you.
                    </p>
