            ...
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
                ...
                <div className="space-y-6">
                    ...
                    <p className="text-gray-700 text-lg leading-relaxed font-medium">
                        Legends are no longer just the faces of brands—they are the brands themselves, building empires and transforming fan engagement into monetization. By reshaping the creator economy, they’re disrupting a $75B+ global sports media market and shifting power from corporations to creators.
                    </p>
                </div>
