    ...
    const items = [
        {
            ...
            desc: "LegendsTV was recently featured on Good Morning Texas, where Co-Founder Deron Guidrey shared how the network is changing the landscape of sports media. The segment spotlighted our legend-owned model and how we’re positioned to disrupt a $75B industry by enabling Legends to connect more personally with their audiences.",
        ...
        },
        {
            ...
            desc: "In an exclusive FinTechTV interview from the floor of the iconic New York Stock Exchange, our Co-Founders share the bold vision behind LegendsTV and how we’re disrupting the sports media landscape. The conversation offers an inside look at the future of legend-led content, the origins of the company, and why this movement is reshaping the entire industry.",
            media: createPlayer(VIDEO_SOURCES[1]),
            reverse: true
        },
        {
            title: "Invest And Secure Your Exclusive Event Invite",
            desc: "All LegendsTV investors enjoy exclusive access to OwnersFest—our annual celebration uniting Legend partners, fans, and investors for an unforgettable experience. As an owner, you’re not on the sidelines—you’re part of the action.",
        ...
        },
        {
            ...
            desc: "Feel the unfiltered energy of our co-founders as they join Kyrie Irving’s historic livestream, discussing the power of Legend ownership, creative freedom, and building a platform that truly serves the culture.",
            media: createPlayer(VIDEO_SOURCES[3]),
            reverse: true
        },
        {
            title: "Watch Our Co-Founder Deron Guidrey On Bloomberg",
            desc: "Watch our Co-Founder on Bloomberg Technology as they break down the mechanics of crowd-sourcing seed funding and the future of fan ownership. Discover how we’re democratizing investment in sports media.",
