            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                ...
                <div className="flex flex-col justify-center lg:pl-8 lg:pt-12">
                    ...
                    <div className="space-y-6 text-gray-400 text-lg leading-relaxed font-medium">
                        <p>
                            LegendsTV is one of the first-ever legend- and fan-owned media companies, built to transform how fans experience legend-driven lifestyle content.
                        </p>
                        <p>
                            Our 360° distribution model—across streaming, social, and direct-to-consumer platforms—empowers Legends to fully control their own narratives.
                        </p>
                        <p>
                            LegendsTV flips the script, placing Legends at the center and unlocking an entirely new media category.
                        </p>
                    </div>
                </div>
            </div>
